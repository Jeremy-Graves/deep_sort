...
# Empty list for Inference times
inference_times = []

# Empty list for CPU Usage
cpu_usage = []

# Empty list for Memory Usage
memory_usage = []

# Empty list for I/O times
io_times = []
...
def generate_detections(encoder, mot_dir, output_dir, detection_dir=None):
    ...
    for sequence in os.listdir(mot_dir):
        ...
        for frame_idx in range(min_frame_idx, max_frame_idx + 1):
            ...
            inference_times.append((inf_end_time - inf_start_time) * 1000)
...
def main():
    ...
    plt.plot(range(1, len(inference_times)+1), inference_times)
    plt.xlabel('Frames')
    ...
    # Plot the CPU Usage
    plt.plot(range(1, len(cpu_usage)+1), cpu_usage)
    plt.xlabel('Frames')
    ...
    # Plot the I/O times
    plt.plot(range(1, len(io_times)+1), io_times)
    plt.xlabel('Frames')
